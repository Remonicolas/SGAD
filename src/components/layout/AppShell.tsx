      ...
      <Sidebar collapsible={isMobile ? "offcanvas" : "icon"} className="border-r">
        <SidebarHeader className="p-4">
          <Link href="/dashboard" className="flex items-center gap-2 group-data-[collapsible=icon]:justify-center">
            ...
            <span className="font-bold text-xl text-primary group-data-[collapsible=icon]:hidden">SGAD-Baxtech</span>
          </Link>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
      ...
      <SidebarInset>
        <header className="sticky top-0 z-30 flex items-center justify-between h-16 px-4 bg-background/80 backdrop-blur-sm border-b">
          <div className="flex items-center">
            ...
            <span className="text-lg font-semibold md:hidden">SGAD-Baxtech</span>
          </div>
